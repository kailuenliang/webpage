...
if((count%2) == 0){
    for(var x = 0; x < width; x+= random(200)){
      noStroke();
      fill(100,100,random(100,255),random(200));
      ellipse(x,int(random(height)),random(10));
    ...
    for(var y = 0 ; y < height; y+=random(200)){
        noStroke();
        fill(200,30,random(100,200),random(100));
       ellipse(int(random(width)),y,int(random(10)));
    }
} else{
